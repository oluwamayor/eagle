                                    ...
                                    <li>
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:info@eaglevisionltd.com" style="text-decoration: none;">
                                                <h4 style="color: #4D72D0;">info@eaglevisionltd.com</h4>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+2349090055448" style="text-decoration: none;">
                                                <h4 style="color: #4D72D0;">+234 9090 055 448</h4>
                                            </a>
                                        </div>
                                    </li>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto nav-sub">
                                <li class="nav-item ">
                                    <a class="nav-link " href="index" id="navbarDropdown" role="button"
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " href="services" id="navbarDropdown" role="button"
                                        aria-haspopup="true" aria-expanded="false">
                                        Services
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link " href="gallery" id="navbarDropdown" role="button"
                                        aria-haspopup="true" aria-expanded="false">
                                        Gallery
                                    </a>
                                </li>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " href="appointment" id="navbarDropdown" role="button"
                                        aria-haspopup="true" aria-expanded="false">
                                        Appointment
                                    </a>
                                </li>
